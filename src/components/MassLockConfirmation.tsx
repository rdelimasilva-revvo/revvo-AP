...
import { X, Lock, AlertTriangle, CheckCircle, TrendingUp } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">Confirmar Operações</h2>
              <p className="text-sm text-gray-600">Revise os detalhes antes de confirmar</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="text-sm text-green-700 mb-1">Valor Total a Travar</div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-blue-800">
                    Após confirmar, serão criados <strong>{operationsWithAmount.length} contratos</strong> e os
                    recebíveis correspondentes serão marcados como travados. Esta operação não pode ser desfeita.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50">
          ...
          >
            ...
            {canProceed ? (
              <span>Confirmar {operationsWithAmount.length} Operações</span>
            ) : (
