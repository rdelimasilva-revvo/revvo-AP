...
import {
  ...
  LayoutDashboard, Calendar, FileCheck, BarChart3, Wallet,
...
const sections: SectionItem[] = [
  { id: 'overview', label: 'Captura de Recebíveis', keywords: ['captura', 'recebíveis', 'recebiveis', 'overview', 'dashboard', 'início', 'inicio', 'home'], icon: <LayoutDashboard className="w-4 h-4" /> },
  { id: 'schedule-view', label: 'Visão de Agendas', keywords: ['agenda', 'agendas', 'visão', 'visao', 'schedule', 'clientes'], icon: <Calendar className="w-4 h-4" /> },
  ...
  { id: 'contracts', label: 'Operações', keywords: ['operações', 'operacoes', 'operação', 'contratos', 'contrato', 'trava'], icon: <FileText className="w-4 h-4" /> },
  ...
  { id: 'settlement-accounts', label: 'Contas de Liquidação', keywords: ['contas', 'conta', 'liquidação', 'bancária', 'bancaria'], icon: <Building2 className="w-4 h-4" /> },
