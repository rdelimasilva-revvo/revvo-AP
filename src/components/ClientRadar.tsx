...
export const ClientRadar: React.FC<ClientRadarProps> = ({ client, onBack }) => {
  const [selectedPeriod] = useState<'7days' | '30days' | '90days' | '180days'>('30days');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Disponibilidade de Recebíveis</h3>
          ...
          <div className="mt-6 space-y-6">
            <div className="space-y-4">
              <div>
                ...
                <select
                  value={pastFilter}
                  onChange={(e) => setPastFilter(e.target.value as any)}
