...
export const GuaranteesJourney: React.FC<GuaranteesJourneyProps> = ({ isOpen, onClose }) => {
  ...
  const renderUploadStep = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Escolha como adicionar os clientes para captura de recebíveis</p>
      </div>
                  ...
                  >
                    <div className="text-left">
                      ...
                      {!hasContract && hasOptInAuth && (
                        <p className="text-xs text-green-600 font-medium mt-1">Autorização confirmada</p>
                      )}
                    </div>
                    <div className="flex items-center space-x-3">
                      <CheckCircle className={`w-5 h-5 ${hasContract ? 'text-green-600' : hasOptInAuth ? 'text-green-600' : 'text-gray-400'}`} />
  ...
  const renderSummaryStep = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Passo 3: Resumo da Captura</h3>
        <p className="text-gray-600">Processo de captura concluído com sucesso</p>
      </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              ...
              <li>• A captura mensal de recebíveis foi configurada. Acompanhe o progresso em Monitoramento</li>
              <li>• A cada nova janela mensal, o sistema renovará automaticamente a captura</li>
            </ul>
          </div>
        </div>
      </div>
