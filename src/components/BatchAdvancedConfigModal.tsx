...
import { X, Zap, Calendar, ChevronDown, ChevronUp, RefreshCw } from 'lucide-react';
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, contractDurationMonths: e.target.value === '' ? null : Number(e.target.value) }))}
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Renova a captura automaticamente a cada nova janela mensal</div>
                </div>
              </div>
