...
import { ManagementViewDashboard } from './components/ManagementViewDashboard';
...
function App() {
  ...
  const pageTitleMap: Record<string, string> = {
    ...
    'management-view': 'Visão gerencial',
    ...
    'disputes-automation': 'Automações de Contestação',
  ...
  const renderContent = () => {
    ...
    switch (activeSection) {
      ...
      case 'management-view':
        return <ManagementViewDashboard />;
      case 'monitoring':
